...
import { Content, ModalAddCreditCard, PaymentInfo, TitleBox } from './styles';
  ...
  return (
    <BoxShadow style={{ width: '100%', height: '100%', gap: '2rem' }}>
      <ReactModal
        ...
        onRequestClose={handleCancelAddingNewCreditCard}
        style={{
          overlay: {
            position: 'fixed',
            top: 0,
        ...
        contentElement={(props, children) => <ModalAddCreditCard {...props}>{children}</ModalAddCreditCard>}
      >
        <form onSubmit={handleAddingNewCreditCard}>
